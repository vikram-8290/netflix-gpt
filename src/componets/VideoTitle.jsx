const VideoTitle = ({ title, overview }) => {
    return (
        <div className=" bg-opacity-80 text-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:scale-105 max-w-2xl aspect-video mb-4">
